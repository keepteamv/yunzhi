...
const Edit = ({ submitting, dispatch }) => {
  ...
  const onFinish = values => {
    setError([]);
    dispatch({
      type: 'managerAndEquipmentAndEdit/submitAdvancedForm',
      payload: values,
    });
  };
...
export default connect(({ loading }) => ({
  submitting: loading.effects['managerAndEquipmentAndEdit/submitAdvancedForm'],
}))(Edit);
