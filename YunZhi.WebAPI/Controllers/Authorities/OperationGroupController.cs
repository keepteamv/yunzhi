...
namespace YunZhi.WebAPI.Controllers.Authorities
{
    public class OperationGroupController : YunZhiControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost("getPages")]
        [Permission("authority.getpages.operationgroup")]
        ...
        /// <returns></returns>
        [HttpGet("getList")]
        [Permission("authority.getlist.operationgroup")]
        ...
        /// <returns></returns>
        [HttpPost("create")]
        [Permission("authority.create.operationgroup")]
        ...
        /// <returns></returns>
        [HttpPost("update")]
        [Permission("authority.update.operationgroup")]
