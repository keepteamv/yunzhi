...
namespace LRMTC.Infrastructure.Services
{
    ...
    public class RedisService
    {
        ...
        public RedisService()
        {
            var _config = ConfigSettings.RedisConfig;
        ...
        {
            DefaultKey = prefixKey;
        }
        /// <summary>
        /// 更新db索引
        /// </summary>
        /// <param name="db"></param>
        public void DatabaseChange(int db)
        {
            _db = _connMultiplexer.GetDatabase(db);
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="prefixKey"></param>
        public RedisService UsePrefixKey(string prefixKey = "")
        {
            DefaultKey = prefixKey;
            return this;
        }
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public RedisService UseDb(int db)
        {
            _db = _connMultiplexer.GetDatabase(db);
            return this;
        }
